...
export default function EngineersPage() {
  ...
  const filteredEngineers = useMemo(() => {
    ...
    return engineers.filter((engineer) =>
      [engineer.fullName, engineer.email].join(' ').toLowerCase().includes(q),
    );
  }, [engineers, search]);
  ...
  return (
    <section className="engineers-page">
      <div className="engineers-page__hero">
        <div className="engineers-page__hero-main">
          <div>
            <p className="engineers-page__eyebrow">Workforce</p>

            <h2 className="engineers-page__title">Engineers</h2>

            <p className="engineers-page__subtitle">
              Manage engineers available for maintenance planning and field assignments.
            </p>
          </div>
        ...
        <div className="engineers-page__stats">
          <div className="engineers-page__stat-card">
            <span className="engineers-page__stat-label">Total</span>
      ...
      {error ? <div className="engineers-page__alert">{error}</div> : null}
        ...
        <section className="engineers-page__state-card">
          ...
          <p>
            {search.trim()
              ...
              : 'Create your first engineer to continue.'}
          </p>
        </section>
      ) : (
